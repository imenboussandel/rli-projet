...
function generateBitDiagram(frame) {
    ...
    // Ajouter l'axe vertical au début
    var verticalAxis = document.createElement('div');
    verticalAxis.classList.add('vertical-axis');
    bitsContainer.appendChild(verticalAxis);
